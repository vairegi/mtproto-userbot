...
async def fetch_search_page(
    ...
    *,
    ...
    """One /api/v2/search call. Returns the raw JSON blob so we cache
    upstream verbatim — the mini-app's scraper_bridge already knows how
    to deserialise this exact shape."""
    params: Dict[str, Any] = {
        "query": query or "",
