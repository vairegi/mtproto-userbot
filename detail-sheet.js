console.info('[detail-sheet] build=v12.51');
/*
...
function mountSimilarRow(root, gid) {
  if (!root || !gid) { console.warn('[similar-to-this] skipped — missing root or gid'); return; }
  if (!root.querySelector || !document.body) { console.warn('[similar-to-this] no DOM ready'); return; }
  if (!gid) return;
  const section = h("div", {
    class: "d-similar",
    style: {
